...
namespace AlienSync.Scp
{
	...
	public class Program
	{
		...
		private static void ShowUsage()
		{
			var sb = new StringBuilder();
			sb.AppendLine("Usage:");
			sb.AppendLine("  AlienSync.exe");
			sb.AppendLine();
			sb.AppendLine("Configuration:");
			sb.AppendLine("  Enter correct information into AlienSync.Scp.exe.config before executing this application.");
			sb.AppendLine();
